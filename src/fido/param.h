...
#define CTAP_CBOR_LARGE_BLOBS		0x0c
...
#define FIDO_EXT_LARGE_BLOB_KEY	0x04
...
#define FIDO_EXT_ASSERT_MASK	(FIDO_EXT_HMAC_SECRET|FIDO_EXT_LARGE_BLOB_KEY)
#define FIDO_EXT_CRED_MASK	(FIDO_EXT_HMAC_SECRET|FIDO_EXT_CRED_PROTECT|FIDO_EXT_LARGE_BLOB_KEY)
